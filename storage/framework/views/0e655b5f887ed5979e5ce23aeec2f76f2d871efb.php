                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="min_amount" id="min_amount" value="<?php echo e(old('min_amount')); ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="max_amount" id="max_amount" value="<?php echo e(old('max_amount')); ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="percentange" id="percentange" value="<?php echo e(old('percentange')); ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="max_no_taxable_amount" id="max_no_taxable_amount" value="<?php echo e(old('max_no_taxable_amount')); ?>">
                    ...
                    <div class="card-block">
                        ...
                        <div class="table-responsive">
                            <table id="basic-table" class="display table nowrap table-striped table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        <th><?php echo e(__('field_min_amount')); ?></th>
                                        <th><?php echo e(__('field_max_amount')); ?></th>
                                        <th><?php echo e(__('field_percentage')); ?></th>
                                        <th><?php echo e(__('field_max_no_taxable_amount')); ?></th>
                                  ...
                                  <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                          ...
                                          <?php echo e(number_format((float)$row->min_amount, $setting->decimal_place, '.', '')); ?> 
                                          <?php else: ?>
                                          <?php echo e(number_format((float)$row->min_amount, 2, '.', '')); ?> 
                                          <?php endif; ?>
                                        ...
                                        <td>
                                          <?php if(isset($setting->decimal_place)): ?>
                                          <?php echo e(number_format((float)$row->max_amount, $setting->decimal_place, '.', '')); ?> 
                                          <?php else: ?>
                                          <?php echo e(number_format((float)$row->max_amount, 2, '.', '')); ?> 
                                          <?php endif; ?>
                                          <?php echo $setting->currency_symbol; ?>
                                        ...
                                        <td>
                                          <?php if(isset($setting->decimal_place)): ?>
                                          <?php echo e(number_format((float)$row->percentange, $setting->decimal_place, '.', '')); ?> 
                                          <?php else: ?>
                                          <?php echo e(number_format((float)$row->percentange, 2, '.', '')); ?> 
                                          <?php endif; ?>
                                          %
                                        </td>
                                        <td>
                                            <?php if(isset($row->max_no_taxable_amount)): ?>
                                            <?php if(isset($setting->decimal_place)): ?>
                                                <?php echo e(number_format((float)$row->max_no_taxable_amount, $setting->decimal_place, '.', '')); ?> 
                                                <?php else: ?>
                                                <?php echo e(number_format((float)$row->max_no_taxable_amount, 2, '.', '')); ?> 
                                                <?php endif; ?>
                                                <?php echo $setting->currency_symbol; ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\tax-setting\index.blade.php ENDPATH**/ ?>