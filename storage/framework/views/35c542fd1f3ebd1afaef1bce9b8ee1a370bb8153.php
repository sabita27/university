...
<div class="template-container" id="downloadable" style="border-image: url('<?php echo e(asset('uploads/'.$path.'/'.$certificate->template->background)); ?>') 30 round; width: <?php echo e($certificate->template->width); ?>; height: <?php echo e($certificate->template->height); ?>;">
    ...
    <script type="text/javascript">
        "use strict";
        var pdf_title =  '<?php echo e($certificate->template->title); ?>-<?php echo e($certificate->serial_no); ?>' + '.pdf'
...
</html><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\certificate\download.blade.php ENDPATH**/ ?>