...
<div class="main-body">
    <div class="page-wrapper">
        ...
        <div class="procurement-header">
            ...
            <a href="<?php echo e(route('admin.procurement.create')); ?>" class="btn btn-add-request"><i class="fas fa-plus"></i> Add Request</a>
        </div>
                ...
                <table id="basic-table" class="table table-procurement display nowrap table-striped table-hover" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($row->procurement_number); ?></td>
                            <td><?php echo e($row->name); ?></td>
                            <td><?php echo e(optional($row->request_date)->format('d M, Y') ?? ''); ?></td>
                            <td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\procurement\index.blade.php ENDPATH**/ ?>