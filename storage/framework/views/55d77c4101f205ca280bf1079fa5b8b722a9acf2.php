    ...
    <table class="table-no-border">
        <tbody>
            ...
            <tr>
                <td class="temp-logo">
                  <div class="inner">
                    <?php if(is_file('uploads/outsider/'.$row->memberable->photo)): ?>
                    <img src="<?php echo e(asset('uploads/outsider/'.$row->memberable->photo)); ?>" alt="Photo">
                    <?php else: ?>
    ...
    <table class="table-no-border">
        <tbody>
            ...
            <tr class="meta-data">
                ...
                <td class="value">: <?php echo e(__('field_outsider')); ?></td>
            </tr>
            <tr class="meta-data">
...
</html><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\library-outsider\card.blade.php ENDPATH**/ ?>