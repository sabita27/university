              ...
              <form class="needs-validation" novalidate action="<?php echo e(route($route.'.update', $row->id)); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="color" class="form-control form-control-color" name="color" id="color" value="<?php echo e($row->color); ?>" required>
...
<?php /**PATH C:\xampp\htdocs\university\resources\views\admin\crm\lead-status\edit.blade.php ENDPATH**/ ?>