                ...
                <?php echo csrf_field(); ?>
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                <label for="marks" class="form-label"><?php echo e(__('field_marks')); ?> <span>*</span></label>
                                <input type="text" class="form-control autonumber" name="marks" id="marks" value="<?php echo e(old('marks')); ?>" required>

                                <div class="invalid-feedback">
                                  <?php echo e(__('required_field')); ?> <?php echo e(__('field_marks')); ?>
                            ...
                            <table id="basic-table" class="display table nowrap table-striped table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(__('field_marks')); ?></th>
                                        <th><?php echo e(__('field_result_contribution')); ?></th>
                                ...
                                <tbody>
                                  ...
                                  ?>
                                    <tr>
                                        ...
                                        <td><?php echo e(round($row->marks, 2)); ?></td>
                                        <td><?php echo e(round($row->contribution, 2)); ?> %</td>
                                        <td>
                                            <?php if( $row->status == 1 ): ?>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th><?php echo e(round($total_marks, 2)); ?></th>
                                        <th><?php echo e(round($total_contribution, 2)); ?> %</th>
                                        <th></th>
                                        <th></th>
                                    </tr>
                                </tfoot>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\exam-type\index.blade.php ENDPATH**/ ?>