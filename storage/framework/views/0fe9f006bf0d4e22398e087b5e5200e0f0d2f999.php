                ...
                <table id="basic-table" class="table table-premium display nowrap table-hover" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('admin.asset-brand.status', $row->id)); ?>" class="status-toggle-link">
                                    <span class="status-switch <?php if($row->status == 1): ?> active <?php endif; ?>"></span>
                                </a>
                            </td>
                            <td>
                                <button type="button" class="btn-action-edit" data-bs-toggle="modal" data-bs-target="#editModal-<?php echo e($row->id); ?>">
                                    <!-- Feather edit icon -->
                                ...
                                <button type="button" class="btn-action-delete" data-bs-toggle="modal" data-bs-target="#deleteModal-<?php echo e($row->id); ?>">
...
<div id="createModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form class="needs-validation" novalidate action="<?php echo e(route('admin.asset-brand.store')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="modal-header">
                    <h5 class="modal-title">Add Asset Brand</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label class="form-label" for="brand_title">Brand Name <span>*</span></label>
                        <input type="text" class="form-control" name="title" id="brand_title" placeholder="Enter brand name" value="<?php echo e(old('title')); ?>" required>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\asset\brand\index.blade.php ENDPATH**/ ?>