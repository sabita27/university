                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="start_day" id="start_day" value="<?php echo e($row->start_day); ?>" required data-v-max="999999999" data-v-min="0">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="end_day" id="end_day" value="<?php echo e($row->end_day); ?>" required data-v-max="999999999" data-v-min="0">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\fees-fine\edit.blade.php ENDPATH**/ ?>