    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background-image: url("<?php echo e(asset('web/img/bg/university-bg.png')); ?>");
...
<body>
    ...
    <div class="container-wrapper">
        <div class="form-card">
            ...
            <form action="<?php echo e(route('admission.request.store')); ?>" method="post">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="father_name" id="father_name" class="form-control" placeholder="Father's name" value="<?php echo e(old('father_name')); ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="phone">Phone Number<span>*</span></label>
                            <input type="text" name="phone" id="phone" class="form-control" placeholder="Enter the number" value="<?php echo e(old('phone')); ?>" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" name="email" id="email" class="form-control" placeholder="Enter the email" value="<?php echo e(old('email')); ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="educational_qualification" id="educational_qualification" class="form-control" required>
                                ...
                                <option value="<?php echo e($qualification->title); ?>" <?php if(old('educational_qualification') == $qualification->title): ?> selected <?php endif; ?>><?php echo e($qualification->title); ?></option>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="board" id="board" class="form-control" placeholder="School/College/University" value="<?php echo e(old('board')); ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="total_mark">Total Mark<span> *</span></label>
                            <input type="text" name="total_mark" id="total_mark" class="form-control" placeholder="Enter total mark" value="<?php echo e(old('total_mark')); ?>" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="total_percentage" id="total_percentage" class="form-control" placeholder="Enter percentage" value="<?php echo e(old('total_percentage')); ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="lead_source" id="lead_source" class="form-control" required>
                                ...
                                <option value="<?php echo e($source->id); ?>" <?php if(old('lead_source') == $source->id): ?> selected <?php endif; ?>><?php echo e($source->title); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" class="form-control" rows="3" placeholder="Tell us more about your interest..." required><?php echo e(old('description')); ?></textarea>
                </div>
...
<?php /**PATH C:\xampp\htdocs\university\resources\views\web\lead-form.blade.php ENDPATH**/ ?>