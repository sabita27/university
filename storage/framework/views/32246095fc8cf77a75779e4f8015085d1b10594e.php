  ...
  <div class="template-inner">
    ...
    <table class="table-no-border">
        <tbody>
            <tr>
                <td class="temp-title">
                  <h2><?php echo e(__('field_staff_id')); ?>: <?php echo e($row->staff_id); ?></h2>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="table-no-border">
        <tbody>
            <tr>
                ...
                <td class="meta-data value">: <?php echo e(route('login')); ?></td>
...
</html><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\user\password-print.blade.php ENDPATH**/ ?>