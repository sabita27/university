                ...
                <div class="card">
                    ...
                    <form id="wizard-advanced-form" class="needs-validation" novalidate action="<?php echo e(route($route.'.store')); ?>" method="post" enctype="multipart/form-data" style="display: none;">
                      <?php echo csrf_field(); ?>
                        ...
                        <content class="form-step">
                            <!-- Form Start--->
                            <?php if(field('student_photo')->status == 1 || field('student_signature')->status == 1): ?>
                            <fieldset class="row scheduler-border">
                        ...
                        <h3><?php echo e(__('tab_transfer_info')); ?></h3>
                        <content class="form-step">
                            <!-- Form Start--->
                            <fieldset class="row scheduler-border">
                              <div class="form-group col-md-4">
...
<?php $__env->startSection('page_js'); ?>
    ...
    (function ($) {
        ...
        $(document).on('click', '#addDocument', function () {
            ...
            html += '<div class="form-group col-md-4"><label for="t_titles" class="form-label"><?php echo e(__('field_title')); ?> <span>*</span></label><input type="text" class="form-control" name="titles[]" id="t_titles" value="<?php echo e(old('titles')); ?>" required><div class="invalid-feedback"><?php echo e(__('required_field')); ?> <?php echo e(__('field_title')); ?></div></div>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\student-transfer-in\create.blade.php ENDPATH**/ ?>