                                ...
                                <tbody>
                                  <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($row->stocks->where('status', 1)->sum('quantity') - $row->issues->where('status', 0)->sum('quantity')); ?></td>
                                        <td><?php echo e($row->stocks->where('status', 1)->sum('quantity') - ($row->issues->where('status', 0)->sum('quantity') + $row->issues->where('status', 1)->sum('quantity'))); ?></td>
                                        <td>
                                            <?php if( $row->status == 1 ): ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\item\index.blade.php ENDPATH**/ ?>