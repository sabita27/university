    ...
    <div class="modal fade" id="unpayModal-<?php echo e($row->id); ?>" tabindex="-1" role="dialog" aria-labelledby="UnpayModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-sm">
          <form action="<?php echo e(route($route.'.unpay', $row->id)); ?>" method="post">
            <?php echo csrf_field(); ?>
    ...
    </div><!-- /.modal --><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\fees-student\unpay.blade.php ENDPATH**/ ?>