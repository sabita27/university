                            ...
                            <table class="table table-attendance table-striped table-hover table-bordered printable">
                                ...
                                <tbody>
                                  ...
                                  ?>
                                    <tr>
                                        <td>
                                            #<a href="<?php echo e(route('admin.staff-hourly-attendance.report.details', $row->id)); ?>"><?php echo e($row->staff_id); ?></a>
                                        </td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\staff-hourly-attendance\report.blade.php ENDPATH**/ ?>