                ...
                <?php echo csrf_field(); ?>
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                <label for="fee"><?php echo e(__('field_fee')); ?> (<?php echo $setting->currency_symbol; ?>) <span>*</span></label>
                                <input type="text" class="form-control autonumber" name="fee" id="fee" value="<?php echo e(old('fee')); ?>" required>
                                ...
                                <tbody>
                                  <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e(round($row->fee, $setting->decimal_place ?? 2)); ?> <?php echo $setting->currency_symbol; ?></td>
                                        <td>
                                            <?php if( $row->status == 1 ): ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\transport-route\index.blade.php ENDPATH**/ ?>