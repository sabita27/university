                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-12">
                                            <ul class="breadcrumb" style="background: transparent; padding: 0; margin-bottom: 5px;">
                                                ...
                                                <li class="breadcrumb-item"><a href="<?php echo e(route('supplier.stock.index')); ?>" class="text-muted">My Stocks</a></li>
                                                <li class="breadcrumb-item text-muted">Add Stock</li>
                                            </ul>
                                            <div class="page-header-title">
                                                <h5 class="m-b-10" style="font-weight: 700; color: #333;">Add Stock</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="card" style="border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); border: none;">
                                        <div class="card-header text-white" style="background-color: #0d6efd; border-radius: 10px 10px 0 0; padding: 20px;">
                                            <h5 class="text-white m-0" style="font-weight: 600;">Add New Stock</h5>
                                        </div>
                                        
                                        <form class="needs-validation" novalidate action="<?php echo e(route('supplier.stock.store')); ?>" method="post" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <div class="card-body">
                                            <?php if($errors->any()): ?>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-4 mb-3">
                                                    ...
                                                    <select class="form-control select2" name="item_id" id="item_id" required>
                                                        ...
                                                        <option value="<?php echo e($item->id); ?>" <?php if(old('item_id') == $item->id): ?> selected <?php endif; ?>><?php echo e($item->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4 mb-3">
                                                    ...
                                                    <select class="form-control" name="store_id" id="store_id" required>
                                                        ...
                                                        <option value="<?php echo e($store->id); ?>" <?php if(old('store_id') == $store->id): ?> selected <?php endif; ?>><?php echo e($store->title); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4 mb-3">
                                                    ...
                                                    <input type="number" class="form-control" name="quantity" id="quantity" value="<?php echo e(old('quantity') ?? 1); ?>" required min="1">
                                                </div>

                                                <div class="form-group col-md-4 mb-3">
                                                    <label for="price" class="form-label">Price <span class="text-danger">*</span></label>
                                                    <input type="number" step="0.01" class="form-control" name="price" id="price" value="<?php echo e(old('price')); ?>" required min="0">
                                                </div>

                                                <div class="form-group col-md-4 mb-3">
                                                    <label for="date" class="form-label">Date <span class="text-danger">*</span></label>
                                                    <input type="date" class="form-control" name="date" id="date" value="<?php echo e(date('Y-m-d')); ?>" required>
                                                </div>
                                        ...
                                        <div class="card-footer" style="background-color: #f8f9fa; border-radius: 0 0 10px 10px;">
                                            <a href="<?php echo e(route('supplier.stock.index')); ?>" class="btn btn-secondary"><i class="fas fa-times"></i> Cancel</a>
                                            <button type="submit" class="btn btn-success"><i class="fas fa-check"></i> Save Stock</button>
                                        </div>
                                        </form>
                                    </div>
                                </div>
...
<?php /**PATH C:\xampp\htdocs\university\resources\views/supplier/stock/create.blade.php ENDPATH**/ ?>