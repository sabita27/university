                    ...
                    <div class="card-block">
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="time" class="form-control time" name="time" id="time" value="<?php echo e(old('time')); ?>">
                        ...
                        <div class="form-group col-md-8">
                            <label for="attach"><?php echo e(__('field_thumbnail')); ?>: <span><?php echo e(__('image_size', ['height' => 600, 'width' => 1200])); ?></span> <span>*</span></label>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\web\web-event\create.blade.php ENDPATH**/ ?>