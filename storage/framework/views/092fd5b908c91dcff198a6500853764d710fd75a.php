...
<div id="addModal-<?php echo e($row->id); ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <form class="needs-validation" novalidate action="<?php echo e(route($route.'.store', $row->id)); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" name="bonus" id="bonus" value="<?php echo e(round($bonus, 0)); ?>" required data_id="add-<?php echo e($row->id); ?>" onkeyup="salaryCalculator('add', <?php echo e($row->id); ?>)">
                    ...
                    <input type="text" name="deduction_salary" value="<?php echo e(round($deduction_salary, 0)); ?>" hidden data_id="add-<?php echo e($row->id); ?>" onkeyup="salaryCalculator('add', <?php echo e($row->id); ?>)">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success"><i class="fas fa-plus"></i> <?php echo e(__('btn_create')); ?></button>
            </div>

          </form>
        </div>
    </div>
</div><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\payroll\create.blade.php ENDPATH**/ ?>