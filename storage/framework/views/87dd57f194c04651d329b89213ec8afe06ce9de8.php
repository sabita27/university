                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="statuses[]" id="statuses" multiple required>
                                    ...
                                    <option value="<?php echo e($statusType->id); ?>"><?php echo e($statusType->title); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\fees-discount\index.blade.php ENDPATH**/ ?>