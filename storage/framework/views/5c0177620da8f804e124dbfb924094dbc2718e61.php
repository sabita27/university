                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="isbn" id="isbn" value="<?php echo e(old('isbn')); ?>" required>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="author" id="author" value="<?php echo e(old('author')); ?>" required>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control autonumber" name="quantity" id="quantity" value="<?php echo e(old('quantity')); ?>" required data-v-max="999999999" data-v-min="0">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="section" id="section" value="<?php echo e(old('section')); ?>">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="column" id="column" value="<?php echo e(old('column')); ?>">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="row" id="row" value="<?php echo e(old('row')); ?>">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\book\create.blade.php ENDPATH**/ ?>