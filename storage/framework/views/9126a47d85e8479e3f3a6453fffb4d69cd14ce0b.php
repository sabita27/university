              ...
              <form class="needs-validation" novalidate action="<?php echo e(route($route.'.update', $row->id)); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control autonumber" name="marks" id="marks" value="<?php echo e(round($row->marks, 2)); ?>" required>
    ...
    </div><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\exam-type\edit.blade.php ENDPATH**/ ?>