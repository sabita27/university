                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control select2" name="categories[]" id="categories" multiple>
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($category->id); ?>" <?php if(is_array($row->categories) && in_array($category->id, $row->categories)): ?> selected <?php endif; ?>><?php echo e($category->title); ?></option>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\item-supplier\edit.blade.php ENDPATH**/ ?>