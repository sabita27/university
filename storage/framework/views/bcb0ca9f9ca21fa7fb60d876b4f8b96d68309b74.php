                          ...
                          <div class="row">
                            ...
                            <div class="form-group col-md-6 mt-4">
                                <div class="switch d-inline m-r-10">
                                    <input type="checkbox" id="barcode" name="barcode" value="1" <?php if(isset($row->barcode)): ?> <?php if($row->barcode == 1): ?> checked <?php endif; ?> <?php else: ?> checked <?php endif; ?>>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\visitor-token-setting\index.blade.php ENDPATH**/ ?>