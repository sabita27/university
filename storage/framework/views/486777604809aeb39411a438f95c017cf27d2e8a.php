    ...
    <div class="page-wrapper">
        <div class="enquiry-container">
            ...
            <div class="action-buttons">
                ...
                <?php endif; ?>
                <a href="<?php echo e(route('admin.crm.lead.follow-up-list')); ?>" class="btn-enquiry btn-blue">
                ...
                <a href="<?php echo e(route('admin.crm.lead.export')); ?>" class="btn-enquiry btn-outline-blue">
            ...
            <div class="filter-section">
                ...
                <form action="<?php echo e(route('admin.crm.lead.enquiry')); ?>" method="GET">
                    <div class="filter-grid">
                        <input type="text" name="name" class="form-control filter-control" placeholder="Lead Name" value="<?php echo e(request('name')); ?>">
                        <input type="text" name="email" class="form-control filter-control" placeholder="Email" value="<?php echo e(request('email')); ?>">
                        <select name="status" class="form-control filter-control">
                            ...
                            <option value="<?php echo e($st->id); ?>" <?php if(request('status') == $st->id): echo 'selected'; endif; ?>><?php echo e($st->title); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <select name="agent" class="form-control filter-control">
                            <option value="">All Agents</option>
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($user->id); ?>" <?php if(request('agent') == $user->id): echo 'selected'; endif; ?>><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <div class="filter-actions">
                            ...
                            <a href="<?php echo e(route('admin.crm.lead.enquiry')); ?>" class="btn-reset">
            ...
            <div class="table-section">
                ...
                <div class="tab-content-enquiry">
                            ...
                            <table class="table-enquiry">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="tel:<?php echo e($row->phone); ?>" class="number-link"><?php echo e($row->phone); ?></a></td>
                                        <td><?php echo e($row->source->title ?? 'Marketing'); ?></td>
                                        <td>
                                            <select class="agent-select-inline update-agent" data-lead-id="<?php echo e($row->id); ?>">
                                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($user->id); ?>" <?php if($row->counsellor_id == $user->id): echo 'selected'; endif; ?>>
                                        ...
                                        <td>
                                            <?php $followUp = $row->followUps->first(); ?>
                                            <?php if($followUp && $followUp->follow_up_date): ?>
                                                <?php $fDate = \Carbon\Carbon::parse($followUp->follow_up_date); ?>
                                                <div class="fw-bold <?php echo e($fDate->isPast() ? 'text-danger' : 'text-primary'); ?>"><?php echo e($fDate->format('Y-m-d')); ?></div>
                                                <?php if($fDate->isPast()): ?>
                                        ...
                                        <td>
                                            <select class="status-select-inline update-status" data-id="<?php echo e($row->id); ?>" 
                                                    style="background: <?php echo e($row->leadStatus->color ?? '#e3f2fd'); ?>20; color: <?php echo e($row->leadStatus->color ?? '#1976d2'); ?>;">
                                                <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($st->id); ?>" data-color="<?php echo e($st->color ?? '#1976d2'); ?>" <?php if($row->lead_status_id == $st->id): echo 'selected'; endif; ?>>
                                                    <?php echo e($st->title); ?>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown dropstart">
                                                ...
                                                <ul class="dropdown-menu border-0 shadow">
                                                    <li>
                                                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#viewModal-<?php echo e($row->id); ?>">
                                                            <i class="fas fa-eye"></i> View
                                                        </a>
                                                    </li>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($access.'-edit')): ?>
                                                    <li>
                                                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#editModal-<?php echo e($row->id); ?>">
                                                            <i class="fas fa-edit"></i> Edit
                                                        </a>
                                                    </li>
                                                    <?php endif; ?>
                                                    <li>
                                                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#addFollowUpModal-<?php echo e($row->id); ?>">
                                                            <i class="fas fa-calendar-plus"></i> Add Follow Up
                                                        </a>
                                                    </li>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($access.'-delete')): ?>
                                                    <li>
                                                        <a class="dropdown-item text-danger" href="#" data-bs-toggle="modal" data-bs-target="#deleteModal-<?php echo e($row->id); ?>">
                    ...
                    <div id="lead-from-list" class="tab-pane-enquiry">
                        <div class="p-4">
                            ...
                            <div class="link-copy-area" id="copyLeadLink">
                                <span class="link-text" id="leadLinkUrl"><?php echo e(route('admission.inquiry.index')); ?></span>
                                <div class="copy-hint">
                    ...
                    <div id="lead-kanban-view" class="tab-pane-enquiry">
                        <?php echo $__env->make('admin.crm.lead.kanban-board-partial', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
...
<?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="modal fade" id="viewModal-<?php echo e($row->id); ?>" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content border-0 shadow-lg" style="border-radius: 15px;">
                ...
                <div class="modal-body p-4">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div>
                            <h4 class="mb-0 fw-bold"><?php echo e($row->name); ?></h4>
                            <span class="badge" style="background: <?php echo e($row->leadStatus->color ?? '#eee'); ?>20; color: <?php echo e($row->leadStatus->color ?? '#333'); ?>;"><?php echo e($row->leadStatus->title ?? 'New'); ?></span>
                        </div>
                    </div>
                ...
                <div class="modal-footer border-0">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($access.'-edit')): ?>
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#editModal-<?php echo e($row->id); ?>">Edit Lead</button>
                    <?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="addFollowUpModal-<?php echo e($row->id); ?>" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius: 12px; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                ...
                <form action="<?php echo e(route('admin.crm.lead.add-follow-up')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="lead_id" value="<?php echo e($row->id); ?>">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div class="position-relative">
                                    <input type="date" name="follow_up_date" class="form-control" value="<?php echo e(date('Y-m-d')); ?>" style="border-radius: 10px; border: 1px solid #dee2e6; padding: 12px 15px; background-color: #fff; font-size: 0.9rem;">
                                </div>
                            </div>
                            <div class="col-md-6">
...
<div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 12px;">
            ...
            <form action="<?php echo e(route('admin.crm.lead.import.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="p-3 rounded-3" style="background: #e1f5fe; border: 1px dashed #04a9f5;">
                        <div class="d-flex align-items-start gap-2">
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(asset('dashboard/sample/leads.xlsx')); ?>" class="text-primary fw-bold text-decoration-none small" download>
...
$(document).ready(function() {
    ...
    $('.update-agent').on('change', function() {
        ...
        $.ajax({
            url: "<?php echo e(route($route.'.assign-staff')); ?>",
            type: 'POST',
            data: {
    ...
    $('.update-status').on('change', function() {
        ...
        var urlTemplate = "<?php echo e(route($route.'.update-status', ':id')); ?>";
...
<script>
<?php echo $__env->make('admin.crm.lead.kanban-js-partial', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\crm\lead\enquiry.blade.php ENDPATH**/ ?>