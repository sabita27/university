                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="number" id="number" value="<?php echo e(old('number')); ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="checkbox d-inline">
                                    <input type="checkbox" class="route" name="routes[]" id="route-<?php echo e($key); ?>" value="<?php echo e($transportRoute->id); ?>">
                                    <label for="route-<?php echo e($key); ?>" class="cr"><?php echo e($transportRoute->title); ?></label>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table id="basic-table" class="display table nowrap table-striped table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th><?php echo e(__('field_number')); ?></th>
                                ...
                                <tbody>
                                  <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php $__currentLoopData = $row->transportRoutes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $transportRoute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="badge badge-primary"><?php echo e($transportRoute->title); ?></span><br>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </td>
                                        <td>
                                            <?php if( $row->status == 1 ): ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\transport-vehicle\index.blade.php ENDPATH**/ ?>