    <!-- Edit modal -->
    <div class="modal fade" id="editModal-<?php echo e($row->id); ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel"><?php echo e(__('modal_edit')); ?> <?php echo e($title); ?></h5>
...
<?php /**PATH C:\xampp\htdocs\university\resources\views\admin\crm\qualification\edit.blade.php ENDPATH**/ ?>