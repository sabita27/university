...
<head>
    ...
    <!-- App Title -->
    <title><?php echo e($title); ?> | <?php echo e($setting->meta_title ?? ''); ?></title>
...
<body>
    ...
    <nav class="pcoded-navbar drp-icon-style3 active-lightblue title-lightblue navbar-lightblue brand-lightblue navbar-image-4 menu-item-icon-style5 <?php echo e(\Cookie::get('sidebar')); ?>">
                ...
                <li>
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                <img src="<?php echo e(asset('uploads/user/'.Auth::user()->photo)); ?>" class="img-radius" alt="User Profile" onerror="this.src='<?php echo e(asset('dashboard/images/user/avatar-2.jpg')); ?>';">
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        ...
                                        <div class="card-header">
                                            <form class="needs-validation" novalidate method="POST" action="<?php echo e(route('admin.translations.create')); ?>">
                                                <?php echo csrf_field(); ?>
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col">
                                                        <input type="text" name="key" class="form-control" placeholder="<?php echo e(__('field_key')); ?>..." required>

                                                        <div class="invalid-feedback">
                                                          <?php echo e(__('required_field')); ?> <?php echo e(__('field_key')); ?>

                                                        </div>
                                                    </div>
                                                    <div class="form-group col">
                                                        <input type="text" name="value" class="form-control" placeholder="<?php echo e(__('field_value')); ?>..." required>

                                                        <div class="invalid-feedback">
                                                          <?php echo e(__('required_field')); ?> <?php echo e(__('field_value')); ?>

                                                        </div>

                                                    </div>
                                                    <div class="form-group col">
                                                        <button type="submit" class="btn btn-success"><i class="fas fa-plus"></i> <?php echo e(__('btn_add_new')); ?></button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                                ...
                                                <table class="table table-striped table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php $__currentLoopData = $columns[0]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $columnKey => $columnValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td><a href="#" class="translate-key" data-title="Enter Key" data-type="text" data-pk="<?php echo e($columnKey); ?>" data-url="<?php echo e(route('admin.translation.update.json.key')); ?>"><?php echo e($columnKey); ?></a></td>

                                                                <?php for($i=1; $i<=$columnsCount; ++$i): ?>

                                                                <td><a href="#" data-title="Enter Translate" class="translate" data-code="<?php echo e($columns[$i]['lang']); ?>" data-type="textarea" data-pk="<?php echo e($columnKey); ?>" data-url="<?php echo e(route('admin.translation.update.json')); ?>"><?php echo e(isset($columns[$i]['data'][$columnKey]) ? $columns[$i]['data'][$columnKey] : ''); ?></a></td>

                                                                <?php endfor; ?>

                                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($access.'-delete')): ?>
                                                                <td><button data-action="<?php echo e(route('admin.translations.destroy', $columnKey)); ?>" class="btn btn-icon btn-danger btn-sm remove-key"><i class="fas fa-trash-alt"></i></button></td>
                                                                <?php endif; ?>
                                                            </tr>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        <?php endif; ?>
...
</html><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\translate\index.blade.php ENDPATH**/ ?>