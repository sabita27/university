                    ...
                    <?php echo csrf_field(); ?>
                        <content class="form-step">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="occupation" id="occupation" value="<?php echo e(old('occupation')); ?>">
                            ...
                            <fieldset class="row scheduler-border">
                            <legend><?php echo e(__('field_library_info')); ?></legend>
                            <div class="form-group col-md-12">
                                <label for="library_id"><?php echo e(__('field_library_id')); ?> <span>*</span></label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\library-outsider\create.blade.php ENDPATH**/ ?>