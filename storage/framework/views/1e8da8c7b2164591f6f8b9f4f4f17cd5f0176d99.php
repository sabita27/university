...
<div class="login-card">
    ...
    <div class="login-right">
        ...
        <form action="<?php echo e(route('supplier.login.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div>
            ...
            <div style="display: flex; align-items: center; margin-top: 10px;">
                ...
                <div class="links">
                    ...
                    <a href="<?php echo e(route('supplier.register')); ?>">Vendor Register</a>
                </div>
            </div>
        </form>
    </div>
...
<?php /**PATH C:\xampp\htdocs\university\resources\views\supplier\auth\login.blade.php ENDPATH**/ ?>