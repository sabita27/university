                ...
                <?php echo csrf_field(); ?>
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group ">
                                <label for="attach"><?php echo e(__('field_photo')); ?> <span><?php echo e(__('image_size', ['height' => 'auto', 'width' => 800])); ?></span> <span>*</span></label>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\web\gallery\index.blade.php ENDPATH**/ ?>