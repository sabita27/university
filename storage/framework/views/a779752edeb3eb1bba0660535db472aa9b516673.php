                ...
                <table id="basic-table" class="table table-premium display nowrap table-hover" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="item-count-text"><?php echo e($row->assets_count); ?></span>
                            </td>
                            <td>
                                <a href="<?php echo e(route('admin.asset-type.status', $row->id)); ?>" class="status-toggle-link">
...
<div id="createModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form class="needs-validation" novalidate action="<?php echo e(route('admin.asset-type.store')); ?>" method="post">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" id="type_title" placeholder="Enter type name" value="<?php echo e(old('title')); ?>" required>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\asset\type\index.blade.php ENDPATH**/ ?>