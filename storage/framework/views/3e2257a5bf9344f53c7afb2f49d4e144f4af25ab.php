              ...
              <form class="needs-validation" novalidate action="<?php echo e(route($route.'.update', $row->id)); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control autonumber" name="fee" id="fee" value="<?php echo e(round($row->fee)); ?>" required>
    ...
    </div><?php /**PATH C:\xampp\htdocs\university\resources\views\admin\transport-route\edit.blade.php ENDPATH**/ ?>