...
<div class="navbar-content scroll-div ps ps--active-y">
    <ul class="nav pcoded-inner-navbar">
        ...
        @canany(['crm-lead-view', 'crm-lead-source-view', 'crm-lead-status-view'])
        <li class="nav-item pcoded-hasmenu crm-nav-item {{ Request::is('admin/crm*') ? 'pcoded-trigger active' : '' }}">
            <a href="#!" class="nav-link">
                <span class="pcoded-micon"><i class="fas fa-handshake"></i></span>
                <span class="pcoded-mtext">{{ trans_choice('module_crm', 1) }}</span>
            </a>
            <ul class="pcoded-submenu">

                @can('crm-lead-source-view')
                <li class="{{ Request::is('admin/crm/lead-source*') ? 'active' : '' }}"><a href="{{ route('admin.crm.lead-source.index') }}">{{ trans_choice('module_lead_source', 2) }}</a></li>
                @endcan

                @can('crm-lead-status-view')
                <li class="{{ Request::is('admin/crm/lead-status*') ? 'active' : '' }}"><a href="{{ route('admin.crm.lead-status.index') }}">{{ trans_choice('module_lead_status', 2) }}</a></li>
                @endcan

                @can('crm-qualification-view')
                <li class="{{ Request::is('admin/crm/qualification*') ? 'active' : '' }}"><a href="{{ route('admin.crm.qualification.index') }}">{{ trans_choice('module_qualification', 2) }}</a></li>
                @endcan

                @can('crm-lead-view')
                <li class="{{ Request::is('admin/crm/enquiry*') ? 'active' : '' }}"><a href="{{ route('admin.crm.lead.enquiry') }}">Lead Enquiry</a></li>
                @endcan
            </ul>
        </li>
        @endcanany

        <li class="nav-item procurement-nav-item {{ Request::is('admin/procurement*') ? 'active' : '' }}">
            <a href="{{ route('admin.procurement.index') }}" class="nav-link">
        ...
        {{--
        <li class="nav-item pcoded-hasmenu asset-nav-item {{ Request::is('admin/asset*') || Request::is('admin/asset-assignment*') ? 'pcoded-trigger active' : '' }}">
            <a href="#!" class="nav-link">
                <span class="pcoded-micon"><i class="fas fa-spinner"></i></span>
                <span class="pcoded-mtext">Asset Management</span>
            </a>
            <ul class="pcoded-submenu">
                <li class="{{ Request::is('admin/asset/brand*') ? 'active' : '' }}"><a href="{{ route('admin.asset-brand.index') }}" class="">Asset Brands</a></li>
                <li class="{{ Request::is('admin/asset/type*') ? 'active' : '' }}"><a href="{{ route('admin.asset-type.index') }}" class="">Asset Types</a></li>
                <li class="{{ Request::is('admin/asset') || Request::is('admin/asset/create') || Request::is('admin/asset/*/edit') || Request::is('admin/asset/*/show') ? 'active' : '' }}"><a href="{{ route('admin.asset.index') }}" class="">Assets</a></li>
                <li class="{{ Request::is('admin/asset-assignment*') ? 'active' : '' }}"><a href="{{ route('admin.asset-assignment.index') }}" class="">Asset Assignment</a></li>
            </ul>
        </li>
        --}}
