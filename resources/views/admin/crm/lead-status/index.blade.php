                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                ...
                                <input type="color" class="form-control form-control-color" name="color" id="color" value="#3fbada" required>
                                ...
                                <tbody>
                                  @foreach( $rows as $key => $row )
                                    <tr>
                                        ...
                                        <td>{{ $row->title }}</td>
                                        <td>
                                            <span class="badge" style="background-color: {{ $row->color }}; color: #fff;">{{ $row->color }}</span>
                                        </td>
                                        <td>
                                            @if( $row->status == 1 )
