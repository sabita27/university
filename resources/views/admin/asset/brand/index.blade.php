                ...
                <table id="basic-table" class="table table-premium display nowrap table-hover" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $row->title }}</td>
                            <td>
                                <a href="{{ route('admin.asset-brand.status', $row->id) }}" class="status-toggle-link">
...
<div id="createModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form class="needs-validation" novalidate action="{{ route('admin.asset-brand.store') }}" method="post">
                @csrf
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" id="brand_title" placeholder="Enter brand name" value="{{ old('title') }}" required>
