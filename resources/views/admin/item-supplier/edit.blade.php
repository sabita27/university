                ...
                <div class="card">
                    ...
                    <div class="card-block">
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            <label for="categories">{{ __('field_category') }}</label>
                            <select class="form-control select2" name="categories[]" id="categories" multiple>
                                @foreach($categories as $category)
                                    <option value="{{ $category->id }}" @if(is_array($row->categories) && in_array($category->id, $row->categories)) selected @endif>{{ $category->title }}</option>
                                @endforeach
                            </select>
