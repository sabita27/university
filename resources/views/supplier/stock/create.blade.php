                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card" style="border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); border: none;">
                                        ...
                                        <form class="needs-validation" novalidate action="{{ route('supplier.stock.store') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="card-body">
                                            @if ($errors->any())
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-4 mb-3">
                                                    ...
                                                    <select class="form-control select2" name="item_id" id="item_id" required>
                                                        ...
                                                        <option value="{{ $item->id }}" @if(old('item_id', request('item_id')) == $item->id) selected @endif>{{ $item->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4 mb-3">
                                                    ...
                                                    <select class="form-control" name="store_id" id="store_id" required>
                                                        ...
                                                        <option value="{{ $store->id }}" @if(old('store_id') == $store->id) selected @endif>{{ $store->title }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4 mb-3">
                                                    ...
                                                    <input type="number" class="form-control" name="quantity" id="quantity" value="{{ old('quantity') ?? 1 }}" required min="1">
                                                </div>

                                                <div class="form-group col-md-4 mb-3">
                                                    <label for="price" class="form-label">Price <span class="text-danger">*</span></label>
                                                    <input type="number" step="0.01" class="form-control" name="price" id="price" value="{{ old('price') }}" required min="0">
                                                </div>
