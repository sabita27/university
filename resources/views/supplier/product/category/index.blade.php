                    ...
                    <div class="main-body">
                        <div class="page-wrapper">
                            ...
                            <div class="sp-card">
                                ...
                                <div class="table-responsive">
                                    <table class="sp-table">
                                        ...
                                        <tbody>
                                            ...
                                            @empty
                                            <tr>
                                                <td colspan="6" class="text-center text-muted" style="padding:30px;">No categories found. <a href="{{ route('supplier.product.category.create') }}">Add one now</a>.</td>
                                            </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
                                ...
                                <div style="padding: 15px 18px;">{{ $categories->links() }}</div>
                                @endif
                            </div>
